...
initial begin
    $readmemh("C:\\Users\\Filip\\Desktop\\Assignment_CPU\\CPU_test_1\\test.vh", program_memory.r_buffer);
    ...
    //$readmemh("reference.vh", data_memory.r_buffer);
    $readmemh("C:\\Users\\Filip\\Desktop\\Assignment_CPU\\CPU_test_1\\reference.vh", r_reference);
    r_clk = 1'b0; r_resetn = 1'b0; #25; r_resetn = 1'b1;
    #600;
